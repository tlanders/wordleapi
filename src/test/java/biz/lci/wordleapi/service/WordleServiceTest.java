...
class WordleServiceTest {
    ...
    public void testRecommend() {
        ...
        testPossibleSolutions(List.of("onion", "inion"), List.of("c-a-n?o!n!", "u-n!i!o!n!")); // "n?y-l-o!n!"
        ...
        testExactSolution("onion", List.of("c-a-n?o!n!", "u-n!i!o!n!", "i-n!i!o!n!")); // "n?y-l-o!n!"
        testExactSolution("yummy", List.of("m?a-y?b-e-", "c-o-y?l-y!", "g-u!p-p-y!")); // "n?y-l-o!n!"
//        testExactSolution("eerie", List.of("s-n-e?e?r?", "g-e!n-r?e!", "s-e!r!v-e!", "h-e!r!y-e!", "m-e!r!d-e!"));
        testExactSolution("mummy", List.of("a-m?m!o-s-", "m!i-m!i-c-"));
        testExactSolution("gamma", List.of("m-u-m!m!y-", "b-e-a?c-h-", "l-i-m!m!a!", "n-a!m!m!a!"));
